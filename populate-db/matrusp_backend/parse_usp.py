...
def main():
	...
	for unidade, codigo in codigos_unidades.items():
		...
		if campus not in campi: campi[campus] = []
...
async def iterar_unidades(codigos_unidades):
	...
	return [i for i in materias_tasks if i]
...
if __name__ == "__main__":
	...
	parser.add_argument('diretorio_destino', help="diretório que irá conter os arquivos resultantes",default=".")
	...
	parser.add_argument('-o','--out',help="arquivo de saída do banco de dados completo", type=str, default="jupiter_web.json")
